...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"CHENNAI SRM Express","VELLACHERY THORAIPAKKAM Express","SRM VIT Express","MIT SRM Express","IIT SRM Express","IIM SRM Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
   printf("                                     WELCOME TO BUS TIC-ETING SYSTEM                                    \n\n\n");
    ...
    do
{
	...
	i=0;
		...
		if(strcmp(uname,"chakry")==0 && strcmp(pword,"kesava")==0)
	{
	printf("  \n\n\n      LOGIN IS SUCCESSFUL!");
